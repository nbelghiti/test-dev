...
export class MigrationsRunningError extends CustomError {
	public message: string = 'Migrations are currently being executed';
	public name: string = 'Bad Request';
	public status: number = 400;
}

// Team
export class NoMembersProvidedError extends CustomError {
	public message: string = 'There were no members provided for this team.';
}

export class UserSyncError extends CustomError {
	public message: string = 'Something went wrong while fetching users on Auth0 to sync.';
}
